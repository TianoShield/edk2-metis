/** @file
  Host-compatible PCD Library based on BasePcdLibNull.

  Identical to BasePcdLibNull except PcdSet*S functions return
  RETURN_SUCCESS instead of asserting.  This allows drivers that
  call PcdSet64S (e.g. EmuVariableFvbRuntimeDxe) to initialise
  without crashing in host-based fuzz harnesses.

  Original: Copyright (c) 2006 - 2018, Intel Corporation. All rights reserved.<BR>
