/** @file
  ...
  This header defines the internal data structures used by the
  protocol database: IHANDLE, PROTOCOL_ENTRY, PROTOCOL_INTERFACE,
  OPEN_PROTOCOL_DATA, and PROTOCOL_NOTIFY.  These match the edk2
  DxeCore structures with two differences:

  1. No OrderedCollection member in IHANDLE (no gOrderedHandleList).
  2. OPEN_PROTOCOL_DATA tracks Agent/Controller/Attributes/OpenCount
     exactly as upstream for full OpenProtocol tracking support.

  Also declares internal helpers (CoreFindProtocolEntry,
  CoreNotifyProtocolEntry, CoreFindProtocolInterface,
  CoreRemoveInterfaceFromProtocol, CoreConnectSingleController,
...
extern LIST_ENTRY       mProtocolDatabase;
