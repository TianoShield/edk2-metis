/** @file
  ...
  Copied from edk2/MdeModulePkg/Core/Dxe/Event/Event.h for host-based
  fuzzing.  This is the real DXE Core IEVENT structure and prototypes,
  used instead of the old MOCK_EVENT approach.

  Changes from upstream:
    - Renamed from Event.h to EventDxeCore.h to avoid header collision.
    - No functional changes to structure or prototypes.
...
#ifndef __EVENT_DXE_CORE_H__
#define __EVENT_DXE_CORE_H__
