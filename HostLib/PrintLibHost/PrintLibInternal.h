/** @file
  ...
  Identical to upstream — no modifications.

  AUDIT (2025):
  =============
  Defines internal flag constants (PREFIX_SIGN, LONG_TYPE, OUTPUT_UNICODE,
  FORMAT_UNICODE, ARGUMENT_UNICODE, PRECISION, COUNT_ONLY_NO_PRINT, etc.),
  UNSIGNED_TYPE flag, TIME struct (matches EFI_TIME layout), and function
  declarations for the 6 internal workers.  MAX string size constants
  MAXIMUM_VALUE_CHARACTERS (38) used for ValueBuffer in format engine.
