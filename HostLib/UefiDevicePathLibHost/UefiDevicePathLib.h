...
SPDX-License-Identifier: BSD-2-Clause-Patent
  ...
  AUDIT: HBFAplus host-side DevicePathLib internal header.
  Declares internal types (POOL_PRINT, table structures, vendor-path structs)
  and UefiDevicePathLib* internal function prototypes.  Identical to the
  upstream edk2 header.  No modifications needed for host fuzzing.
**/
